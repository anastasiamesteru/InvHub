        ...
        <div className="p-4 h-w-full h-screen">
            <div className="flex flex-col">
                <div className="flex items-center justify-between border-b-2 border-purple-500">
                    <p className="text-gray-700 text-m flex-1 py-4">Explore your invoice data and transform number into valuable knowledge</p>
            ...
            <div>
                <table className="w-full border-collapse text-sm overflow-auto">
                    <thead>
                        <tr>
                            <th className="px-3 py-2 text-center bg-gray-200">1 number</th>
                            <th className="px-3 py-2 text-center bg-gray-200">2</th>
                            <th className="px-3 py-2 text-center bg-gray-200">3</th>
                            <th className="px-3 py-2 text-center bg-gray-200">4 Date</th>
                            <th className="px-3 py-2 text-center bg-gray-200">4</th>
                            <th className="px-3 py-2 text-center bg-gray-200">6</th>
                            <th className="px-3 py-2 text-center bg-gray-200">7</th>
                        </tr>
                    </thead>
                    <tbody>
