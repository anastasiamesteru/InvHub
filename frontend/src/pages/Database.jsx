...
const Database = () => {
    ...
    const handleDelete = async (id) => {
        ...
        if (activeTab === "clients") deleteEndpoint = `/client/delete/${id}`;
        else if (activeTab === "vendors") deleteEndpoint = `/vendor/delete/${id}`;
        else if (activeTab === "items") deleteEndpoint = `/item/delete/${id}`;
